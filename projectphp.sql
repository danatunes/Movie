...
--
-- Хост: 127.0.0.1
-- Время создания: Июн 02 2021 г., 07:25
...
(14, 'The Umbrella Academy', '2019-02-15', 16, '01:00:00', 'Steve Blackman', 'Действие разворачивается в альтернативной вселенной. В середине 20-го века 43 женщины, которые до этого не были беременны, одновременно рожают младенцев, наделённых суперспособностями. Пришелец, скрывающийся под личиной сэра Реджинальда Харггривса, спасает семерых новорождённых и создаёт Академию «Амбрелла». Вместе они используют свои таланты для защиты Земли. Годы спустя, после распада Академии, ученики встречаются на похоронах Харггривса. Им предстоит вновь объединиться ради защиты человечества и выступить против одного из бывших соратников по Академии.', 'https://m.media-amazon.com/images/M/MV5BNzA5MjkwYzMtNGY2MS00YWRjLThkNTktOTNmMzdlZjE3Y2IxXkEyXkFqcGdeQXVyMjkwMzMxODg@._V1_SY1000_CR0,0,680,1000_AL_.jpg', 'https://api1586495923.multikland.net/embed/movie/5332');
...
--
-- Структура таблицы `user_will_watch`
--
...
--
-- Дамп данных таблицы `user_will_watch`
--
...
--
-- Индексы таблицы `user_will_watch`
--
...
--
-- Ограничения внешнего ключа таблицы `user_will_watch`
--
ALTER TABLE `user_will_watch`
